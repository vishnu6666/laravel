...
@section('content')
  ...
  background-image:
    url( {{ url('admin-assets/images/background/background.png') }});  ">
            ...
            <!-- Login box start -->
            <div class="login-box card "  style=" box-shadow: 0px 5px 11px 8px #03a9f3;">
                <div class="card-body">
                    @include('admin.common.flash')
                    <form class="form-horizontal form-material" id="forgotform" method="post"  action="{{ route('AdminForgotPassword')}}">
                        ...
                        <div class="form-group text-center p-b-10">
                            ...
                            <div class="ml-auto m-t-10">
                                <a href="{{ route('adminLogin') }}"  class="text-muted"> Back to Login </a>
                            </div>
                        </div>
                    </form>
                </div>
