...
@endsection
@section('title') Refer Codes @endsection
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Refer codes</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Refer codes</li>
                        </ol>
                        <a href="{{ route('referCode.create')}}" class="btn btn-info d-none d-lg-block m-l-15">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Refer codes</h4>
    ...
    <script>
        $(document).ready(function () {
            ...
            table = $('#promoCode').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    "url":'{{ url(route("referCode.search"))  }}',
                    "type": "POST",
                    "async": false,
                },
                columns: [
                    { data: 'sr_no' ,name:'sr_no', orderable:false },
                    { data: 'referCode', name: 'referCode' },
                    { data: 'title', name: 'title' },
                    { data: 'numberOfparson', name: 'numberOfparson' },
