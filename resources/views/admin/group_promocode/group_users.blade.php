        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Add Members : {{ $group->groupName }}</h4>
                </div>
            ...
            <div class="alert alert-danger alertdisapper" id="error">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    There is some problem to add member
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <button type="submit" style="float: right;" class="btn btn-success" id="userAsign" data-id="{{ $group->id}}">Add Members</button>
...
<script>
    ...
    $(document).on('click', '#userAsign', function () {
        ...
        var groupId =  $('#userAsign').attr('data-id');
        ...
        if (matches.length === 0) {
            ...
            $.ajax({
            type: "post",
            url: "{{ url(route('groups.asignUserGroup'))  }}",
            dataType: "json",
