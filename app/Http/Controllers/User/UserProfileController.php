...
class UserProfileController extends Controller
{
    ...
    */
    public function updateProfile(Request $request){
        ...
        if($admin->save()) {
            ...
            return redirect(route('EditUserProfile'))->with('success', trans('messages.profile.update.success'));
        }

        return redirect(route('EditUserProfile'))->with('error', trans('messages.profile.update.error'));
    }
    ...
    */
    public function profileImageDelete()
    {
        ...
        if($admin->save())
        {
            return redirect()->route('EditUserProfile')->with('success', trans('messages.profile.delete.success'));
        }

        return redirect()->route('EditUserProfile')->with('error', trans('messages.profile.delete.error'));
    }
    ...
    */
    public function updateAdminChangePassword(Request $request){
        ...
        if (\Hash::check($request->current_password, $currentPassword)) {
            ...
            return redirect(route('EditUserChangePassword'))->with('success', trans('messages.changePassword.success'));
        }

        return redirect(route('EditUserChangePassword'))->with('error', trans('messages.changePassword.error'));
    }
}
