...
@section('title') Payment Transaction Report @endsection
@section('css')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Payment Transaction Report</h4>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                <form class="form" name="paymentReport" id="paymentReport" method="post" enctype="multipart/form-data" action="{{ route('admin.paymentTransactionReportDetail') }}">
                    {{ csrf_field() }}
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
