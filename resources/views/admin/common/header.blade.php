         ...
         <div class="navbar-header" style="">
            <a class="navbar-brand" href="{{ route('AdminDashboard') }}">
               ...
               <span class="hidden-sm-down">
                  ...
                  <!-- Light Logo text -->    
                  <img src="{{ url('admin-assets/images/logo/full_logo_new.png')}}" class="light-logo" alt="homepage" style="height: 56px;" />
               </span> 
            </a>
         </div>
         <!-- ============================================================== -->
            ...
            <!-- ============================================================== -->
               ...
               <li class="nav-item dropdown u-pro">
                     <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ $adminImage  }}" alt="user" class=""> <span style="    color: #ffff;" class="hidden-md-down font-weight-bold">{{ isset($admin->name) ? $admin->name : '' }} &nbsp;
                           <i class="fa fa-angle-down"></i></span>
                     </a>
                     <div class="dropdown-menu dropdown-menu-right animated flipInY">
                        <!-- text-->
                        <a href="{{ route('EditAdminProfile') }}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                        <!-- text-->
                        <a href="{{ route('EditAdminChangePassword')}}" class="dropdown-item"><i class="ti-wallet"></i> Change Password</a>
                        <!-- text-->
