         ...
         <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br>
                    <div class="row">
                        <div class="col-md-2 col-xs-6"> <strong>Profile Image</strong>
                            <br>
                            @php
                        ...
                        <div class="col-md-2 col-xs-6 b-r"> <strong>Email</strong>
                         ...
                         <div class="col-md-2 col-xs-6 b-r"> <strong>Mobile Number</strong>
                            <br>
                            <p class="text-muted">{{ $userInfo->mobileNumber ?? '-'  }}</p>
                        </div>
                        <div class="col-md-2 col-xs-6"> <strong>Joining Date</strong>
                            <br>
                            <p class="text-muted">{{ $userInfo->joinDate ?? '-'  }}</p>
                        </div>
                        <div class="col-md-2 col-xs-6"> <strong> Password</strong>
                            <br>
