...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar" style="box-shadow: 7px 2px 13px 4px #cab7b7f2;">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li> <a class=" waves-effect waves-dark" href="{{ route('userDashboard') }}" aria-expanded="false"><i class="fas fa-tachometer-alt"></i><span class="hide-menu">Dashboard </span></a> </li>   
