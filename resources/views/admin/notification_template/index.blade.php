        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor"> Notification Templates </h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{ route('notification-templates.create')}}" class="btn btn-info d-none d-lg-block m-l-15">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="notificationTemplate" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                    <th>Sr.No.</th>
                                    <th>Title</th>
                                    <th>Description</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = "";
            table = $('#notificationTemplate').DataTable({
                processing: true,
                serverSide: true,
                "ajax": {
                    "url":'{{ url(route("notification-templates.search"))  }}',
                    "type": "POST",
                    "async": false,
                },
                columns: [
