                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="agile1 scale">
                            <tr>
                                <td class="agile-main scale-center-both" style="font-weight: 400; color: #000; font-size: 15px; text-align:left; height:34px !important;">You are receiving this email because <b>{{ $teamMember->senderName }}</b> send a league invitation request for your account.</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="esd-block-button shop_btn" align="center" style="padding:15px 0;">
                                    <span class="es-button-border" style="border-radius: 20px; border-style: solid; border-width: 0px;">
                                        Here is <b>{{$teamMember->leagueName }}</b> league invitation : <a href="{{ $url }}" class="btn btn-primary"> Click Here </a>
                                    </span>
                                </td>
                            </tr>
                            <tr>
