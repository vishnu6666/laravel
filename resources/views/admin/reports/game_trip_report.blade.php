...
@section('title') Game Tips Report @endsection
@section('css')
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Game Tips Report</h4>
                </div>
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Game Tips Report</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                <form class="form" name="paymentReport" id="paymentReport" method="post" enctype="multipart/form-data" action="{{ route('admin.gameTripReportDetail') }}">
                    {{ csrf_field() }}
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
