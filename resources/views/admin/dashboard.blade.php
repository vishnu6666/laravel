            ...
            <div class="card-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-muted text-uppercase">No. of Users</p>
                                            </div>
                                            <div class="ml-auto">
                                                 <h2 class="counter text-cyan"> {{ $users ?? '0' }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3 class="text-primary"><i class="fas fa-dollar-sign"></i></h3>
                                            <p class="text-muted text-uppercase">Total Revenue</p>
                                        </div>
                                        <div class="ml-auto">
                                        <h2 class="counter text-primary">  {{ $revenue ?? '0' }}</h2>
                                        </div>
                   ...
                   <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('manage-tips.index')}}">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3 class="text-info"><i class="far fa-object-group"></i></h3>
                                            <p class="text-muted text-uppercase">No. of Games Tip</p>
                                        </div>
                                        <div class="ml-auto">
                                        <h2 class="counter text-info">  {{ $gameTip ?? '0' }}</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('manage-transaction.index')}}">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3 class="text-info"><i class="far fa-money-bill-alt"></i></h3>
                                            <p class="text-muted text-uppercase">Total Purchased Subscriptions</p>
                                        </div>
                                        <div class="ml-auto">
                                        <h2 class="counter text-info">  {{ $subscription ?? '0' }}</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
