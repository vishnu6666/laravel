        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Subscription plans</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{ route('subscription-plans.create')}}" type="button" class="btn btn-info d-none d-lg-block m-l-15">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="subscriptionPlans" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Plan name</th>
                                            <th>Plan weekly price</th>
                                            <th>Plan monthly price</th>
                                            <th>Create date</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
...
<script>
    var table;
    $(function() {
        table = $('#subscriptionPlans').DataTable({
            processing: true,
            serverSide: true,
            "ajax": {
                "url":'{{ url(route("subscription-plans.search"))  }}',
                "type": "POST",
                "async": false,
            },
            columns: [
                ...
                { data: 'planWeeklyPrice', name: 'planWeeklyPrice'},
                { data: 'planMonthlyPrice', name: 'planMonthlyPrice'},
