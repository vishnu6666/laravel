                            ...
                            @else
                                <form class="form" name="Userupdate" id="Userupdate" method="post" enctype="multipart/form-data" action="{{ route('users.update', ['user' => $user->id]) }}">
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-5">
                                            <input class="form-control" type="text" value="{{ $user->showPassword ?? '' }}" name="password" id="password"  placeholder="Please enter password" tabindex="4" required >
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
                                        <label for="password_confirmation"  class="col-2 col-form-label "> Confirm password <span class="text-danger">*</span></label>
                                        <div class="col-5">
                                            <input class="form-control" type="text"  name="password_confirmation" value="{{ $user->showPassword ?? '' }}" id="password_confirmation"  placeholder="Please enter confirm password" tabindex="5" required >
                                        </div>
                                    </div>
                                    <div class="form-group m-t-40 row">
