...
@section('title') Package wise Message List  @endsection
@section('css')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="packages" class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <th>Sr.No.</th>
                                        <th>Package name</th>
